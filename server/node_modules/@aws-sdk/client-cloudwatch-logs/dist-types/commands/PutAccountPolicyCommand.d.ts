 ...
 *
 */
export declare class PutAccountPolicyCommand extends $Command<PutAccountPolicyCommandInput, PutAccountPolicyCommandOutput, CloudWatchLogsClientResolvedConfig> {
     ...
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<PutAccountPolicyCommandInput, PutAccountPolicyCommandOutput>;
    /**
     * @internal
     */
    private serialize;
