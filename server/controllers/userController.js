...
var userController = {};
userController.createUser = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
    var _a, username, password, hashedPassword, newUser, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _b.trys.push([2, 4, , 5]);
                return [4 /*yield*/, User.create({ username: username, password: hashedPassword })];
            case 3:
                newUser = _b.sent();
...
userController.login = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                if (userResult === null || userResult === undefined) {
                    return [2 /*return*/, next({
                            log: "The following error occured: ".concat(error),
                            status: 400,
