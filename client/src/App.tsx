...
export const FunctionArnContext = createContext<
  | {
      funcArn: string;
      setFuncArn: React.Dispatch<React.SetStateAction<string>>;
    }
  | undefined
>(undefined);
export const FunctionDataContext = createContext<
  | {
      funcData: any[];
      setFuncData: React.Dispatch<React.SetStateAction<any[]>>;
    }
  | undefined
>(undefined);
export const WarmingContext = createContext<
  | {
      warmArray: any[];
      setWarmArray: React.Dispatch<React.SetStateAction<any[]>>;
    }
  | undefined
>(undefined);
